...
if len(sys.argv) < 6:
    print("参数少于6：villeggiaturaloan.py [sid] [date] [start_dt] [end_dt] [cust_isn ..]")
    exit(1)
...
""" % (s, start_dt, end_dt, date)
    ...
    while (r):
        ...
        GREEN_STAT = r["GREEN_STAT"]			# 8.2 绿色经营情况
        tmpSql = ("INSERT INTO villeggiatura ("
                    ...
                    "CONCERN_LEVEL,IS_LAW_ABIDING,GREEN_STAT) "
                    "VALUES ('%s','%s','%s',"   # 1
                    "%s,%s,%s,"                 # 2
                    "%s,%s,%s,"                 # 3
                    "%s,%s,%d,"                 # 4
...
if (flag == False):
    print('两山乡居贷取数失败，强制退出!')
    exit()

print("两山乡居贷取数成功！将%d条数据存入MySQL.." % len(resList))
...
# python villeggiaturaloan.py 1000123456 20180221 20170201 20180201 101330523197103126635 101330523197411146611 101330523196105276616