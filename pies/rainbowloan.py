...
if len(sys.argv) < 6:
    print("参数少于6：rainbowloan.py [sid] [date] [start_dt] [end_dt] [cust_isn ..]")
    exit(1)
...
print("丰收彩虹贷取数成功！将%d条数据存入MySQL.." % len(resList))
...
# python rainbowloan.py 1000123456 20180221 20170201 20180201 101330327198602147245 101330523196506282515 101330523199803096827