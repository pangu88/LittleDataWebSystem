...
var whitetealoan_pies = require('../pies/whitetealoan_pies');
var xlsx = require('node-xlsx');

var whitetea_helper = {};

whitetea_helper.handle = function (username, sid, dateS, filepath) {
    ...
    for (var i = 1; i < data.length; i ++) {
        ...
        var sql = `insert into whitetea_base (SSID,xid,name,sfzhm,zhihang,xzc)`
    ...
    var afterHandle = function () {
        ...
        whitetealoan_pies.handle(username, sid, dateNum, startDt, endDt, idList);
    }
    var cnt = 0;
    sqlList.forEach((sql)=>{
        console.log(sql);
...
module.exports = whitetea_helper;